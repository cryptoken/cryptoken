## Cloud Engineer & AI Builder

8 years in MSP environments. Azure certified (AZ-104, AZ-305, AI-102).
...
`Copilot Studio` `M365` `Power Automate` `PowerShell` `Python` `Claude Code`
